[← 先决条件](0-Prerequisites-CN.md) | 安装[(English)](1-Installation-EN.md) | [首页 →](../README-CN.md)
***
...
然后，执行 Composer 命令安装最新版 Alibaba Cloud KMS SDK for PHP 作为依赖项：
```bash
...
请[下载 .zip 文件](http://aliyunsdk-pages.alicdn.com/php-sdk/kms.zip)，然后在项目中的选定位置解压，最后将自动加载工具包含到您的脚本中，如下所示：
